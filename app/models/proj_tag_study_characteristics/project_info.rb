  ...
  class ProjectInfo < ProjectInfoTemplate
    ...
    def self.meta_info
      { name:                'Characteristics of Clinical Trials Registered in ClinicalTrials.gov, 2007-2010',
        ...
        description:         'This project used ClinicalTrials.gov data to summarize characteristics of 40,970 interventional trials registered between October 2007 and September 2010.  Characteristics were compared between trials in three clinical specialties: mental health, cardiovascular and oncology.',
