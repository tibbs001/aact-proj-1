...
module AactProj
  class Application < Rails::Application
    ...
    AACT_DB_SUPER_USERNAME = ENV['AACT_DB_SUPER_USERNAME'] || 'tibbs001'   # Name of postgres superuser that has permission to create a database.
    ...
    AACT_PROJ_DB_NAME      = ENV['AACT_PROJ_DB_NAME'] || 'aact_proj'
    ...
    if Rails.env != 'test'
      ...
      AACT_PUBLIC_DATABASE_NAME = 'open_trials_test'
      AACT_ALT_PUBLIC_DATABASE_NAME = 'open_trials_alt_test'
    end
