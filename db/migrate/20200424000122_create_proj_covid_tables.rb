class CreateProjCovidTables < ActiveRecord::Migration[5.2]

  def up

    execute "CREATE SCHEMA proj_covid;"
    execute "GRANT USAGE ON SCHEMA proj_covid to read_only;"
    execute "GRANT SELECT ON ALL TABLES IN SCHEMA proj_covid TO read_only;"

    create_table "proj_covid.covid_study_ids" do |t|
      t.string  'nct_id'
    end
...
#    SQL
  ...
  def down
    execute "DROP SCHEMA proj_covid CASCADE;"
  end
